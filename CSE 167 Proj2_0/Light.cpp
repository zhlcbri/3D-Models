...
//void Light::setObj(const char *filepath) {
//    if (obj == nullptr) obj = new OBJObject(filepath);
//}
...
void Light::draw(GLuint shaderProgram) {
    ...
    //
//    cout << "light_mode: " << light_mode << endl;
//    cout << "light_color.x: " << light_color.x << "light_color.y: " << light_color.y << "light_color.z: " << light_color.z << endl;
}
